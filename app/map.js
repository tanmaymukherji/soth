// SoTH Map — Leaflet + OpenStreetMap (reliable basemap) + BharatAtlas geocoding
...
soth.map = {
  ...
  createMap: async function (containerId, center, zoom) {
    ...
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
      attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors &bull; Geocoding via <a href="https://bharatlas.com">BharatAtlas</a>/<a href="https://mappls.com">Mappls</a>',
      maxZoom: 19,
    }).addTo(soth.map._map);
  ...
  // BharatAtlas geocoding — uses LGD village polygon bounding box for approximate coords
  ...
  // Mappls geocoding via REST API (fallback)
